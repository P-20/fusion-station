...
//Console UI
/obj/machinery/computer/fusion_reactor_control/ui_interact(mob/user, ui_key = "main", datum/tgui/ui = null, force_open = 0, datum/tgui/master_ui = null)
	ui = SStgui.try_update_ui(user, src, ui_key, ui, force_open)
	if(!ui)
		ui = new(user, src, ui_key, "fusion_reactor_control", name, 600, 300, master_ui)
		ui.open()
